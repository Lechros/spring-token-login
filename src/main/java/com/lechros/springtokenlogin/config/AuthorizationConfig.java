...
public class AuthorizationConfig {
     ...
     * 소셜 로그인 처리 URI
     */
    private static String authorizationUri = OAuth2AuthorizationRequestRedirectFilter.DEFAULT_AUTHORIZATION_REQUEST_BASE_URI;
    /**
     * 인증 요청 처리 URI
     */
    private static String redirectionUri = OAuth2LoginAuthenticationFilter.DEFAULT_FILTER_PROCESSES_URI;
